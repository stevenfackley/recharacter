...
-- full DML to these roles at table creation, so the grant below is additive — the
-- REVOKE is what actually strips mutation at the privilege layer. RLS (no update/
-- delete policy) remains the second, independent gate.
